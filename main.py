...
#Game Title
pygame.display.set_caption("Snakes With Chayan")
...
def welcome():
    ...
    while not exit_game:
        ...
        text_screen("Press Enter To Play", red, 250, 290)
        text_screen("(Developed By Chayan Khare)", black, 195, 550)
...
#GameOverScreen
           ...
           gameWindow.fill((233, 210, 229))
           text_screen("Your Score: " + str(score) + "  Hiscore: " + str(highscore), black, 200, 300)
